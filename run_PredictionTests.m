...
for testId = 10
    ...
    numStartPoints = 50;  % number of starting points for prediction test
      
    %% Run prediction tests and save results
    % LSTM_Prediction % run LSTM based prediction
    [errSq,errSqMeanPred, errSqLatestPred, rmseTraining,net] = LSTM_Prediction_Func(data, numStartPoints, numPredSteps, numRepeat, maxEpochs, outputSteps);
